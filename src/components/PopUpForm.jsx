...
const PopUpForm = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      {/* Modal Container */}
      <div className="relative bg-white rounded-lg shadow-lg p-4 w-full max-w-lg md:max-w-3xl relative">
        {/* Close button - Small on mobile */}
        <button
          className="absolute top-2 right-4 text-gray-600 hover:text-gray-800 text-xl md:text-2xl z-50"
          onClick={onClose}
        >
          ✖
        </button>
          ...
          <div className="md:col-span-2">
            ...
            <form className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  type="text"
                  className="w-full px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 text-sm"
              ...
              <div className="flex flex-col md:flex-row justify-between items-center mt-4">
                ...
                <button
                  type="submit"
                  className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold shadow-md transition w-full md:w-auto text-sm"
                >
                  Submit
                </button>
              </div>
